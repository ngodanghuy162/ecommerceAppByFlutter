...
const _detailsSearchUrl = '/detail';
const _autocompleteUrl = '/autocomplete/';
...
class GoogleMapsPlaces extends GoogleWebService {
  ...
  PlacesDetailsResponse _decodeDetailsResponse(Response res) {
    print(res.body);
    return PlacesDetailsResponse.fromJson(json.decode(res.body));
  }

  PlacesAutocompleteResponse _decodeAutocompleteResponse(Response res) {
    print(res.body);
    return PlacesAutocompleteResponse.fromJson(json.decode(res.body));
  }
}
